...
public class Hexadecimal implements Comparable {
	...
	retStr = HEXDIGITS.substring(n,n+1) + retStr;
	return retStr;
    }
    ...
    public static void main( String[] args ) {
        ...
        System.out.println( decToHex(42) );

        System.out.println( decToHexR(10) );
        System.out.println( decToHexR(16) );
        System.out.println( decToHexR(32) );
        System.out.println( decToHexR(42) );
